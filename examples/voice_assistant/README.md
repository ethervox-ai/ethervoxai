...
2. Continue speaking your request. The placeholder STT module emits a final result after roughly two seconds of captured audio.
3. Say `stop` to end the conversation.
