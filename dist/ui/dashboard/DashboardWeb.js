...
const DashboardWeb = () => {
    ...
    const renderOverviewTab = () => (<div className="overview-tab">
      ...
      <div className="query-section">
        ...
        <div className="query-input">
          <input type="text" value={state.currentQuery} onChange={(e) => setState(prev => ({ ...prev, currentQuery: e.target.value }))} placeholder="Enter a test query..." disabled={state.isProcessing}/>
          <button onClick={handleQuerySubmit} disabled={state.isProcessing || !state.currentQuery.trim()}>
            {state.isProcessing ? '⏳ Processing...' : '🚀 Send'}
          </button>
        </div>
        
        {state.lastResponse && (<div className="response-card">
    ...
    const renderLanguageTab = () => (<div className="language-tab">
      <h2>🌐 Multilingual Runtime</h2>
      
      <div className="supported-languages">
        <h3>Supported Languages</h3>
        <div className="language-grid">
          {state.languageProfiles.map(profile => (<div key={profile.code} className={`language-card ${profile.isDefault ? 'default' : ''}`}>
    ...
    const renderLLMTab = () => (<div className="llm-tab">
      <h2>🧠 Local LLM Stack</h2>
      
      <div className="models-section">
        <h3>Available Models</h3>
        <div className="models-grid">
          {state.localModels.map(model => (<div key={model.name} className={`model-card ${model.type}`}>
              ...
              <div className="capabilities">
                ...
                <div className="capability-tags">
                  {model.capabilities.map(cap => (<span key={cap} className="capability-tag">{cap}</span>))}
                </div>
              </div>
            </div>))}
        </div>
    ...
    const renderPrivacyTab = () => (<div className="privacy-tab">
      ...
      <div className="privacy-controls">
        ...
        <div className="settings-group">
          <label className="toggle-setting">
            <input type="checkbox" checked={state.privacySettings.cloudAccessEnabled} onChange={(e) => handlePrivacySettingsUpdate({
          ...
          <label className="toggle-setting">
            <input type="checkbox" checked={state.privacySettings.cloudAccessPerQuery} onChange={(e) => handlePrivacySettingsUpdate({
          ...
          <label className="toggle-setting">
            <input type="checkbox" checked={state.privacySettings.encryptionEnabled} onChange={(e) => handlePrivacySettingsUpdate({
          ...
          <label className="toggle-setting">
            <input type="checkbox" checked={state.privacySettings.auditLoggingEnabled} onChange={(e) => handlePrivacySettingsUpdate({
        ...
        <div className="retention-setting">
          <label>
            ...
            <select value={state.privacySettings.dataRetentionDays} onChange={(e) => handlePrivacySettingsUpdate({
      ...
      <div className="query-history">
        ...
        {state.cloudQueries.length === 0 ? (<p className="no-queries">No cloud queries recorded</p>) : (<div className="query-list">
            {state.cloudQueries.map(query => (<div key={query.id} className="query-item">
      ...
      <div className="device-status">
        ...
        <div className="device-grid">
          {state.deviceStatuses.map(device => (<div key={device.deviceId} className={`device-card ${device.isOnline ? 'online' : 'offline'}`}>
    ...
    return (<div className="dashboard-web">
      <nav className="dashboard-nav">
        ...
        <div className="nav-tabs">
          ...
          <button className={activeTab === 'language' ? 'active' : ''} onClick={() => setActiveTab('language')}>
            🌐 Languages
          </button>
...
exports.DashboardWeb = DashboardWeb;
//# sourceMappingURL=DashboardWeb.js.map